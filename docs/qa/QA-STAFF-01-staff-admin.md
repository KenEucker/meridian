...
3. Create a staff profile with legal name, preferred name, handle, email, phone, city, state, date of birth, and emergency contact fields.
...
8. Edit the staff profile and confirm required fields still validate.
9. Archive and restore the staff profile.
10. Sign in as the restricted admin and attempt to open Staff.

## Expected results

- Staff profile creation requires all required profile fields and rejects invalid email/date values.
