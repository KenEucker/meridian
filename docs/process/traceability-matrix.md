...
| Technical spec: Section 3.1 Server/admin application | In progress | [002](../issues/002-laravel-postgresql-orchid-boot-path.md) |  | Laravel default tests; `composer validate`; `OrchidAdminRouteTest` | [QA-BOOT-01](../qa/QA-BOOT-01-fresh-checkout-boots.md) | Laravel app scaffolded under `apps/server` (M1.1); PostgreSQL configured (M1.2); Orchid admin installed and reachable at the `/admin` route prefix (M1.3). |
