...
| Technical spec: Section 5.1 Core server | In progress | [002](../issues/002-laravel-postgresql-orchid-boot-path.md) |  | Laravel default tests; `composer validate` | [QA-BOOT-01](../qa/QA-BOOT-01-fresh-checkout-boots.md) | Core server framework (Laravel) established (M1.1); PostgreSQL, Orchid, and PowerSync arrive in later tasks. |
