...
| Technical spec: Section 3.1 Server/admin application | In progress | [002](../issues/002-laravel-postgresql-orchid-boot-path.md) |  | Composer validation; Laravel default tests | [QA-BOOT-01](../qa/QA-BOOT-01-fresh-checkout-boots.md) | Initial Laravel server scaffold exists under `apps/server`; PostgreSQL, Orchid, PowerSync, node sync, OpenAPI, and Docker Compose integration remain deferred to later tasks. |
| Technical spec: Section 5.1 Core server | In progress | [002](../issues/002-laravel-postgresql-orchid-boot-path.md) |  | Composer validation; Laravel default tests | [QA-BOOT-01](../qa/QA-BOOT-01-fresh-checkout-boots.md) | Laravel foundation is scaffolded; PostgreSQL configuration, Orchid, OpenAPI, Docker Compose, PowerSync, Caddy, and DNS support remain deferred. |
...
| Technical spec: Section 27.1 Alpha 1 acceptance target | In progress | [002](../issues/002-laravel-postgresql-orchid-boot-path.md) |  | Composer validation; Laravel default tests | [QA-BOOT-01](../qa/QA-BOOT-01-fresh-checkout-boots.md) | Alpha 1 proof target begins with a bootable Laravel foundation; no field workflow target items are implemented yet. |
