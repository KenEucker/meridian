...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('role_permissions', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('permission_role_id')->constrained('permission_roles')->cascadeOnDelete();
        ...
        Schema::create('team_grants', function (Blueprint $table) {
            ...
            $table->foreignUuid('permission_role_id')->constrained('permission_roles')->restrictOnDelete();
            $table->timestamps();
    ...
    private function seedCatalog(): void
    {
        ...
        foreach (PermissionCatalog::roles() as $code => $role) {
            $roleIds[$code] = (string) Str::orderedUuid();
        ...
        foreach (PermissionCatalog::permissions() as $code => $description) {
            $permissionIds[$code] = (string) Str::orderedUuid();
