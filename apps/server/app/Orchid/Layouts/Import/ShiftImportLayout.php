    ...
    public function fields(): array
    {
        return [
            ...
            TextArea::make('csv')
                ...
                ->help(__('Required columns: organization_slug, event_slug, department_code, team_code, title, starts_at, ends_at. Optional: capacity, signup_opens_at, signup_closes_at, schedule_lock_at. Times without a timezone are read in the event timezone, and a date-formatted cell in a workbook is read as the spreadsheet displays it. Rows match existing shifts by event, department, team, title, and start, so changing a title or start creates a new shift instead of renaming one.')),
        ];
    }
}
