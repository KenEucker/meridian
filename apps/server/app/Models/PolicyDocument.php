...
/**
 * Markdown governance document describing organization, department, or team
 * policy (POL-001, POL-003, POL-004, POL-032, and POL-034).
 */
class PolicyDocument extends Model
{
    ...
    protected $allowedFilters = [
        ...
        'title' => Like::class,
        'slug' => Like::class,
        'event_info_section' => Where::class,
        'state' => Where::class,
