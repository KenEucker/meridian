...
final class PermissionCatalog
{
    ...
    public const PERMISSION_FIELD_REPORTS_CREATE_ON_BEHALF = 'field_reports.create_on_behalf';
    ...
    public static function permissions(): array
    {
        return [
            ...
            self::PERMISSION_FIELD_REPORTS_CREATE_ON_BEHALF => 'Take a Field Report on behalf of another staff member, recording them as the author and the taker as the submitter.',
