...
const documents = computed(() => visibleDocuments(session.value, stateFilter.value));
...
function transition(document: ProductDocument, state: ProductDocumentState): void {
  ...
  >
    ...
    <template v-else>
      ...
      <section class="documents__section" aria-labelledby="documents-list-heading">
        <h2 id="documents-list-heading">Policies and procedures</h2>
      ...
      <section class="documents__section" aria-labelledby="fragments-heading">
        <h2 id="fragments-heading">Fragments</h2>
