...
// `pending_sync` state. Server acceptance and FRA numbering are M9.3; the
// author list/detail surface is M9.4; photos are M9.7/M9.8; Name Reference
// parsing is M9.6A. Persisting the record to the encrypted local store and
